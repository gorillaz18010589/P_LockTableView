...
import com.rmondjone.locktableview.UnLockColumnAdapter;
...
public class TableViewAdapter extends RecyclerView.Adapter<TableViewAdapter.TableViewHolder> {
     ...
     * Item点击事件
     */
    private com.rmondjone.locktableview.LockTableView.OnItemClickListenter mOnItemClickListenter;
    ...
    public void onBindViewHolder(final TableViewHolder holder, int position) {
        ...
        if (isLockColumn) {
            ...
            if (mLockAdapter == null) {
                ...
                mLockAdapter.setOnItemSelectedListenter(new com.rmondjone.locktableview.TableViewAdapter.OnItemSelectedListenter() {
        ...
        if (mUnLockAdapter == null) {
            ...
            mUnLockAdapter.setOnItemSelectedListenter(new com.rmondjone.locktableview.TableViewAdapter.OnItemSelectedListenter() {
    ...
    public void setmOnItemClickListenter(com.rmondjone.locktableview.LockTableView.OnItemClickListenter mOnItemClickListenter) {
