package com.example.p_locktableview.locktableview;
...
import com.example.p_locktableview.R;
...
//            Log.e("每行数据", mTableRowDatas.toString());
    ...
    private void initView() {
        ...
        mTableViewAdapter.setHorizontalScrollView(new com.rmondjone.locktableview.LockTableView.OnTableViewListener() {
            @Override
        ...
        mTableViewAdapter.setTableViewRangeListener(new com.rmondjone.locktableview.LockTableView.OnTableViewRangeListener() {
            @Override
        ...
        mTableViewAdapter.setOnTableViewCreatedListener(new TableViewAdapter.OnTableViewCreatedListener() {
            @Override
            public void onTableViewCreatedCompleted(com.rmondjone.locktableview.CustomHorizontalScrollView mScrollView) {
     ...
     */
    public interface OnItemClickListenter extends com.rmondjone.locktableview.LockTableView.OnItemClickListenter {
     ...
     * 创建时间 2018/2/2 下午4:50
     */
    public interface OnItemLongClickListenter extends com.rmondjone.locktableview.LockTableView.OnItemLongClickListenter {
